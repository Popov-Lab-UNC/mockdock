        ...
        if found_cache_dir:
            ...
            if cache_only:
                ...
                raise RuntimeError(
                    ...
                    f"Build the cache first using scripts/dataset/find_matching_documents.py"
                )
            # Fallback message
            ...
            if cache_only:
                raise RuntimeError(
                    ...
                    "python scripts/dataset/find_matching_documents.py --cache-dir data/chembl_cache"
                )
        ...
        try:
            ...
            if (
                ...
                raise RuntimeError(
                    ...
                    f"python scripts/dataset/find_matching_documents.py --cache-dir data/chembl_cache"
                )
    except RuntimeError:
