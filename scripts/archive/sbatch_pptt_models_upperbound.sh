#!/bin/bash
#SBATCH --job-name=pptt_models_clip
...
#SBATCH --output=logs/pptt_models_clip_%j.log
#SBATCH --error=logs/pptt_models_clip_%j.err
...
DEST_ROOT="${BENCHMARK_DIR}/exps_upperbound"
TMP_ROOT="${BENCHMARK_DIR}/_pptt_staging/upperbound"
...
echo "Starting PptT clipped-upperbound model suite at $(date)"
...
echo "All PptT clipped runs completed at $(date)"
