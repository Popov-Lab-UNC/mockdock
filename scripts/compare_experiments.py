...
def main():
    ...
    if not args.uncapped_csv.exists():
        ...
        print("Please run scripts/analyze_experiments.py --exps-dir exps --output-dir analysis_exps first.")
        sys.exit(1)

    if not args.capped_csv.exists():
        print(f"Error: Capped metrics file not found: {args.capped_csv}")
        print("Please run scripts/analyze_experiments.py --exps-dir exps_upperbound --output-dir analysis_exps_upperbound first.")
        sys.exit(1)
