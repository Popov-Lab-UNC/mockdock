"""
AceGen-A2C x FCGMB Benchmark Evaluation
=========================================
Runs AceGen's A2C algorithm against the six FCGMB benchmarks.
...
Note: A2C does not include an experience replay buffer in its standard
AceGen implementation. Fragment conditioning via PromptSMILES serves as the
primary form of domain knowledge injection.
"""

from __future__ import annotations

# ── Algorithm identity (only these three lines change between algorithm folders) ──
ALGORITHM = "a2c"  # identifies this experiment in outputs/logs
SCRIPT_NAME = "a2c"  # subfolder name under acegen-open/scripts/
FUNCTION_NAME = "run_a2c"  # callable inside that script
...
def main(benchmarks, budget, seed, out, acegen_root, n_warmup):
    """Run AceGen-A2C against FCGMB benchmarks."""
