"""
AceGen-PPO x mockdock Benchmark Evaluation
========================================
Runs AceGen's PPO algorithm against the six mockdock benchmarks.
...
ALGORITHM = "ppo"  # identifies this experiment in outputs/logs
SCRIPT_NAME = "ppo"  # subfolder name under acegen-open/scripts/
FUNCTION_NAME = "run_ppo"  # callable inside that script
...
def main(
    ...
    """Run AceGen-PPO against mockdock benchmarks."""
    import datetime
