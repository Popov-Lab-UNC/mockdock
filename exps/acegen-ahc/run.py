"""
AceGen-AHC x FCGMB Benchmark Evaluation
=========================================
...
FCGMB-specific adaptations:
  ...
  - Experience replay: AHC includes a prioritised replay buffer that
...
ALGORITHM = "ahc"  # identifies this experiment in outputs/logs
SCRIPT_NAME = "ahc"  # subfolder name under acegen-open/scripts/
FUNCTION_NAME = "run_ahc"  # callable inside that script
...
def main(benchmarks, budget, seed, out, acegen_root, n_warmup, run_dir):
    """Run AceGen-AHC against FCGMB benchmarks."""
    import datetime
