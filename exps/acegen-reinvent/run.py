"""
AceGen-REINVENT x mockdock Benchmark Evaluation
=============================================
Runs AceGen's REINVENT algorithm against the six mockdock benchmarks.
...
mockdock-specific adaptations:
  ...
  - Experience replay: REINVENT includes a prioritised replay buffer that
...
def _import_algorithm_fn(acegen_root: pathlib.Path):
    ...
    # Use unique module name to avoid conflicts when importing multiple scripts.
