...
===============================================
Runs AceGen's REINFORCE algorithm against the mockdock benchmarks.
...
mockdock-specific adaptations:
  ...
  - Experience replay: REINFORCE includes a prioritised replay buffer that
    accumulates high-reward generated molecules during training.
"""

from __future__ import annotations

# ── Algorithm identity (only these three lines change between algorithm folders) ──
ALGORITHM = "reinforce"  # identifies this experiment in outputs/logs
SCRIPT_NAME = "reinforce"  # subfolder name under acegen-open/scripts/
FUNCTION_NAME = "run_reinforce"  # callable inside that script
