...
def main():
    ...
    pdb_id = "4BZD"
    ligand_resname = "D6I" # The ligand to use for grid box generation. The default is the first hetatm in the PDB file.
    activity_units = "nM" # Units for ChEMBL activity data ('nM', 'uM', etc.)
    
    work_dir = Path("CDK2_workflow")
    ...
    # Plot activity distribution for validation
